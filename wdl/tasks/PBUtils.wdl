...
task QCTranscripts {
    ...
    command <<<
        ...
        python3 /cDNA_Cupcake/sequence/sam_to_collapsed_gff.py out.sam
        python3 /SQANTI3/sqanti3_qc.py --report pdf -t 4 out.collapsed.gff ~{ref_gtf} ~{ref_fasta}

        tree -h
    >>>

    output {
        File classification = "out.collapsed_classification.txt"
        File junctions = "out.collapsed_junctions.txt"
        File report = "out.collapsed_SQANTI3_report.pdf"
    }
